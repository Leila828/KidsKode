...
var angularLink;
var score_sequencing;
var updat;
let routinga;
var angularLink2: BlocklyComponent;
@Component({
...
export class Scene3 extends Phaser.Scene {
  ...
  create() {
    ...
    this.right2 = this.add.image(700, 200, 'right').setInteractive().setName('go1');
    this.right2.scale = 0.7;

    this.up = this.add.image(700, 275, 'up').setInteractive().setName('up');
...
export class Scene1 extends Phaser.Scene {
  ...
  async  helpm() {
    ...
    await this.waitfunction(700);
    this.help = this.add.image(450, 300, 'help').setInteractive();
    this.help.scale = 0.7;
