...
export class Scene4 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("rem", "assets/lila/remind.png");
  }
  closeGameOve2() {

    this.scene.stop("game4")
    this.scene.remove("game4")
  }
  create() {
  ...
  async  help1() {
    // this.load.image("help1", "assets/lila/help1.png");
    const rem = this.add.image(450, 300, 'rem').setInteractive();
    rem.scale = 0.7;
...
*/
  ...
  correct(code) {
    ...
    if (code == you) {
      ...
      this.scene.launch("gameOver", { score: this.score, name: "gameLosee" });
    }
  }
