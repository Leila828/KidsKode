...
export class Game2Component implements OnInit {
  ...
  navigate() {
    this.router1.navigate(["/Dashboard/child"]);
  }
  navigateblockly() {
...
export class MainScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.hand1 = this.add.image(700, 100, "hand2");
    ...
    this.hand2 = this.add.image(360, 450, "hand1");

    this.hand3 = this.add.image(700, 180, "hand2");
    ...
    this.hand4 = this.add.image(650, 500, "hand2");
    this.hand4.visible = false;
    this.hand4.scale = 0.4;
  ...
  preload() {
    ...
    this.load.image("hand1", "assets/aicha/hand2.png");
    this.load.image("hand2", "assets/aicha/hendright.png");
...
//this.closeGameOve();
    ...
    this.bg = this.add.image(400, widnowHeight / 3, "popup2");
    ...
    next.setInteractive();
    retry.setScale(0.6);
    var icebox = this.add.image(360, 287, "icebox");
    icebox.setScale(0.3);
    var scoreText = this.add.text(390, 275, "", { fontSize: "32px" });
...
class Completscene extends Phaser.Scene {
  ...
  create() {
    ...
    var widnowHeight = window.innerHeight;
    // this.bg = this.add.image(400, widnowHeight / 2, "popup");
    this.bg = this.add.image(400, widnowHeight / 3, "complete");

    this.bg.setScale(0.1);
    var next = this.add.image(400, 346, "next");
    next.setScale(0.2);
    next.setInteractive();
    var scoreText = this.add.text(390, 247, "", { fontSize: "32px" });
    var coin = this.add.image(373, 259, "icebox");
    coin.setScale(0.3);
    console.log(this.score);
    scoreText.setText(" " + this.score);
    next.on(
...
class Giftscene extends Phaser.Scene {
  ...
  create() {
    ...
    var widnowHeight = window.innerHeight;
    // this.bg = this.add.image(400, widnowHeight / 2, "popup");
    this.bg = this.add.image(400, widnowHeight / 3, "reward");

    this.bg.setScale(0.6);
    var get = this.add.image(400, 355, "get");
    get.setScale(0.18);
    ...
    var close = this.add.image(490, 117, "close");
...
class finalscene extends Phaser.Scene {
  ...
  create() {
    ...
    var widnowHeight = window.innerHeight;
    // this.bg = this.add.image(400, widnowHeight / 2, "popup");
    this.bg = this.add.image(400, widnowHeight / 4, "finalpopup");

    this.bg.setScale(0.6);
    var next = this.add.image(480, 310, "next");
    next.setScale(0.18);
