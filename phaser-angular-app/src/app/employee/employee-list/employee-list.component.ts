...
export class EmployeeListComponent implements OnInit {
  ...
  console() {
    console.log(
      "ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccchhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh"
    );
  }
  update_score() {
  ...
  score() {
    console.log(
      "scoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"
    );
  }
  ...
  getinfo2(): void {
    console.log(
      "rani dkhalt f moussaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa   "
    );
    this.token.getinfo().subscribe((data) => {
      this.username = data;
      this.id_user = this.username.enfant.id;
  ...
  /* getenfant(): void {
    this.token.getinfo_enfant().subscribe((data) => {
      this.Userdata = data;
...
export class Scene3 extends Phaser.Scene {
  ...
  hit() {
    ...
    lilkharya.update_score();

    sessionStorage.setItem("score2", JSON.stringify(this.score));
    console.log(
      "heeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeey"
    );
...
function loadFont(name) {
  var newFont = new FontFace(
    name,
    `url(phaser-angular-app/src/assets/font.ttf)`
  );
  newFont
    .load()
  ...
  create() {
    ...
    if (this.name == "scene1") {
      ...
      next2.on(event.POINTER_DOWN, (image) => {
        ...
        angularLink.console();
        // this.player.scale = 0.2;
        angularLink.navigate_blockly_loop();
