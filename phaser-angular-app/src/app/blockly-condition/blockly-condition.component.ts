...
//import { Scene5, Scene6, BlocklyComponent } from "../blockly/blockly.component";
...
@Component({
  selector: "app-blockly-condition",
  templateUrl: "./blockly-condition.component.html",
  styleUrls: ["./blockly-condition.component.css"],
})
export class BlocklyConditionComponent implements OnInit {
  workspace: any;
  currentUser: any;
  parent?: Parent;
  username: Parent;
  ...
  constructor(
    ...
    this.config = {
      ...
      parent: "gameok",
      scene: [Scene7, GameOver], // The name of the scene we created
  ...
  ngOnInit(): void {
    this.nav.hide();
    score_condition = this;
    var phaserGame = new Phaser.Game(this.config);
    this.update_score_condition();
  }
...
*/
  ...
  correct(code) {
    ...
    if (code == you) {
      ...
      score_condition.update_score_condition();
