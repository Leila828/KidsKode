...
//const API_URL = "http://192.168.8.101:8881/api/test/";
const API_URL = "http://192.168.8.100:8881/api/test/";
...
export class UserService {
  ...
  getpass(): Observable<any> {
    return this.http.get("http://192.168.8.100:8881/api/auth/token", {
      responseType: "text",
    });
  }
  ...
  getlearning(): Observable<any> {
    return this.http.get(
      "http://192.168.8.100:7777/ms-learning/api/test/learning",
      {
        responseType: "text",
      }
    );
  ...
  getenfantwithscore(id: String): Observable<any> {
    return this.http.get(
      "http://192.168.8.100:7777/ms-authentification/api/test/enfantwithlearning/" +
      id
    );
  }
  getleaderboard(): Observable<any> {
    return this.http.get("http://192.168.8.100:8882/api/test/leaderboard");
    //  .pipe(map((response) => response._embedded.parent));
  }
  getleaderboardlevel1(): Observable<any> {
    return this.http.get("http://192.168.8.100:8882/api/test/leaderboard/level1");
    //  .pipe(map((response) => response._embedded.parent));
  }
  getenfantlearning(id: string): Observable<any> {
    return this.http.get(
      "http://192.168.8.100:8882/api/test/enfant_learning/" + id
    );
    //  .pipe(map((response) => response._embedded.parent));
  }
